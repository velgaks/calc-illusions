export const UI = {
  uk: {
    ...
    people: 'Люди', households: 'Домогосподарства', indicator: 'Показник', breakdown: 'Розріз', noBreakdown: 'Без розрізу', filters: 'Фільтри', addFilter: 'Додати фільтр', remove: 'Видалити',
    ...
    suppressed: 'Значення приховано: у вибірці менш ніж 10 спостережень.', caution: 'Обережно: 10–29 спостережень. Оцінка нестабільна.', reliable: 'Щонайменше 30 спостережень.',
  ...
  en: {
    ...
    people: 'People', households: 'Households', indicator: 'Indicator', breakdown: 'Breakdown', noBreakdown: 'No breakdown', filters: 'Filters', addFilter: 'Add filter', remove: 'Remove',
    ...
    suppressed: 'Value suppressed: fewer than 10 observations.', caution: 'Caution: 10–29 observations. This estimate is unstable.', reliable: 'At least 30 observations.',
