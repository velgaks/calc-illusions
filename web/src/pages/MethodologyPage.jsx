   ...
   (Kish: n_eff = (Σw)² / Σw²) — враховує дисперсію ваг`}</pre>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <strong>Межі децилів у грн — приблизні.</strong> Держстат не публікував
            таблиці розподілу доходів з 2021 року (війна перервала програму). Числа
            у тултіпі слайдера — наша екстраполяція з останніх відкритих даних плюс
            середня зарплата 2024. Порядок правильний, конкретні межі можуть «гуляти»
            на 20-30%.
          </li>
          <li>
...
const RELIABILITY_ROWS = [
  ...
  ['Дохід (дециль)',         'medium',
    'ESS питає про сукупний місячний дохід усього домогосподарства і присвоює дециль. Це частина працює надійно. АЛЕ: межі децилів у грн (видно у тултіпі біля слайдера) — це наша оцінка, не офіційна цифра. Держстат не публікував ОУЖД після 2021 (війна). Реальні межі можуть відрізнятися на 20-30%.'],
